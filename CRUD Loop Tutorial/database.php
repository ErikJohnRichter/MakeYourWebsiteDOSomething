...
class Database
{
    // These are our database variables and will be refereced in the database call. We do this so, 
    // if our credentials change, we only have to change them in one place. A PHP variable always starts with a '$'
    private static $dbName = 'contacts' ;
    private static $dbHost = 'localhost' ;
    private static $dbUsername = 'root';
    private static $dbUserPassword = 'password';
    // This sets the connection to null...closing the connection to the database.
